...
/** REST API controller for customer operations. Provides HTTP endpoints for customer management. */
@RestController
...
public class CustomerController {
  ...
  public Mono<ResponseEntity<CustomerResponse>> getCustomerById(@PathVariable String id) {
    ...
    return customerService
        ...
        .doOnError(
            error -> log.error("Error getting customer by ID {}: {}", id, error.getMessage()));
  }
  ...
  @Operation(
      ...
      description = "Retrieve a specific customer by their email")
  @SecurityRequirement(name = "bearerAuth")
  public Mono<ResponseEntity<CustomerResponse>> getCustomerByEmail(@PathVariable String email) {
    ...
    return customerService
        ...
        .doOnError(
            error ->
                log.error("Error getting customer by email {}: {}", email, error.getMessage()));
  }
  ...
  public Mono<ResponseEntity<CustomerResponse>> createCustomer(
    ...
    return customerService
        .createCustomerManually(request.email(), profile, preferences)
        .map(
            customer ->
        ...
        .doOnError(
            error ->
                log.error("Error creating customer {}: {}", request.email(), error.getMessage()));
  }
  ...
  @Operation(
      ...
      description = "Update an existing customer's profile and preferences")
  @SecurityRequirement(name = "bearerAuth")
  public Mono<ResponseEntity<CustomerResponse>> updateCustomer(
      @PathVariable String id, @Valid @RequestBody CreateCustomerRequest request) {
