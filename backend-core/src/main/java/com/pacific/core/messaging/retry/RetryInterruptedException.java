...
/**
 * Thrown when a retry operation is interrupted while sleeping through backoff. Carries the {@link
 * InterruptedException} as cause; the caller must re-check the interrupt flag.
 */
