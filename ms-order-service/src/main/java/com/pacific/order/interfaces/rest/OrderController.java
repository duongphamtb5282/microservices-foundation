...
/**
 * REST Controller for Order operations Demonstrates CQRS pattern and Feign client authentication
 */
@RestController
...
public class OrderController {
  ...
  public ResponseEntity<ApiResponse<OrderResponse>> getOrder(@PathVariable String orderId) {
    ...
    return ResponseEntity.ok(ApiResponse.success(result.getData().get(), "Order found"));
  }
  ...
  public ResponseEntity<ApiResponse<OrderResponse>> cancelOrder(
    ...
    return ResponseEntity.ok(ApiResponse.success(result.getData(), "Order cancelled successfully"));
  }
}
