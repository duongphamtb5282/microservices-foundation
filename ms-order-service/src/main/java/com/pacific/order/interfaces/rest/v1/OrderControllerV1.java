...
/**
 * REST Controller for Order operations - Version 1 API Version: v1 (Current stable version)
 *
 * <p>This controller provides: - Order creation and management - JWT authentication via Auth
 * Service - Comprehensive error handling - API versioning support
 */
@RestController
...
public class OrderControllerV1 {
  ...
  @Operation(summary = "Get user orders (V1)", description = "Retrieves all orders for a user")
  ...
  public ResponseEntity<ApiResponse<OrderResponse>> cancelOrder(
    ...
    log.info(
        "V1 - Order cancelled successfully: {} by user: {}", orderId, authResponse.getUserId());
