...
/**
 * Service for encrypting/decrypting sensitive data in the Order Service. Handles customer data,
 * payment information, and other sensitive fields.
 */
@Service
...
public class DataEncryptionService {
  ...
  private String maskPaymentMethod(String paymentMethod) {
    ...
    if (paymentMethod.length() >= 4) {
      return "*".repeat(paymentMethod.length() - 4)
