...
/**
 * Gateway filter for JWT authentication. Validates tokens with the Auth Service before allowing
 * requests to proceed.
 */
@Component
@Slf4j
public class AuthenticationFilter
  ...
  @Value(
      "${gateway.filters.authentication.token-validation-url:http://localhost:8082/api/v1/auth/validate}")
  ...
  public static class TokenValidationResponse {
    ...
    public TokenValidationResponse(
        boolean valid, String userId, String username, String correlationId) {
      this.valid = valid;
      this.userId = userId;
